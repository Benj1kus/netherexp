...
public class ModSounds {
    ...
    public static final RegistryObject<SoundEvent> TOTEMUS_PUZZLE = registerSoundEvent("totemus_puzzle");
    public static final RegistryObject<SoundEvent> HIRRING = registerSoundEvent("hirring");
